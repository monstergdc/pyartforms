...
# by 5 + 3 whites for eq 8

colors_BeachTowels = [(0xfe, 0x4a, 0x49), (0x2a, 0xb7, 0xca), (0xfe, 0xd7, 0x66), (0xe6, 0xe6, 0xea), (0xf4, 0xf4, 0xf8), (0xff, 0xff, 0xff), (0xff, 0xff, 0xff), (0xff, 0xff, 0xff)]
colors_MoonlightBytes6 = [(0x4a, 0x4e, 0x4d), (0x0e, 0x9a, 0xa7), (0x3d, 0xa4, 0xab), (0xf6, 0xcd, 0x61), (0xfe, 0x8a, 0x71), (0xff, 0xff, 0xff), (0xff, 0xff, 0xff), (0xff, 0xff, 0xff)]
colors_Number3 = [(0x2a, 0x4d, 0x69), (0x4b, 0x86, 0xb4), (0xad, 0xcb, 0xe3), (0xe7, 0xef, 0xf6), (0x63, 0xac, 0xe5), (0xff, 0xff, 0xff), (0xff, 0xff, 0xff), (0xff, 0xff, 0xff)]
colors_RainbowDash = [(0xee, 0x40, 0x35), (0xf3, 0x77, 0x36), (0xfd, 0xf4, 0x98), (0x7b, 0xc0, 0x43), (0x03, 0x92, 0xcf), (0xff, 0xff, 0xff), (0xff, 0xff, 0xff), (0xff, 0xff, 0xff)]
colors_Google = [(0x00, 0x87, 0x44), (0x00, 0x57, 0xe7), (0xd, 0x62d, 0x20), (0xff, 0xa7, 0x00), (0xff, 0xff, 0xff), (0xff, 0xff, 0xff), (0xff, 0xff, 0xff), (0xff, 0xff, 0xff)]
colors_MetroUI = [(0xd1, 0x11, 0x41), (0x00, 0xb1, 0x59), (0x00, 0xae, 0xdb), (0xf3, 0x77, 0x35), (0xff, 0xc4, 0x25), (0xff, 0xff, 0xff), (0xff, 0xff, 0xff), (0xff, 0xff, 0xff)]
colors_ProgramCat = [(0xed, 0xc9, 0x51), (0xeb, 0x68, 0x41), (0xcc, 0x2a, 0x36), (0x4f, 0x37, 0x2d), (0x00, 0xa0, 0xb0), (0xff, 0xff, 0xff), (0xff, 0xff, 0xff), (0xff, 0xff, 0xff)]
colors_SkinTones = [(0x8d, 0x55, 0x24), (0xc6, 0x86, 0x42), (0xe0, 0xac, 0x69), (0xf1, 0xc2, 0x7d), (0xff, 0xdb, 0xac), (0xff, 0xff, 0xff), (0xff, 0xff, 0xff), (0xff, 0xff, 0xff)]
...
def new_colorer(mode, n, cnt):
    ...
    if mode == 'psych':
        color = colors_p[n%8]
    if mode == 'bw0':
        color = colors_bw0[n%8]
    if mode == 'bwx':
        color = colors_bwx[n%8]
    if mode == 'BeachTowels':
        color = colors_BeachTowels[n%8]
    if mode == 'MoonlightBytes6':
        color = colors_MoonlightBytes6[n%8]
    if mode == 'Number3':
        color = colors_Number3[n%8]
    if mode == 'RainbowDash':
        color = colors_RainbowDash[n%8]
    if mode == 'Google':
        color = colors_Google[n%8]
    if mode == 'MetroUI':
        color = colors_MetroUI[n%8]
    if mode == 'ProgramCat':
        color = colors_ProgramCat[n%8]
    if mode == 'SkinTones':
        color = colors_SkinTones[n%8]
    return color
